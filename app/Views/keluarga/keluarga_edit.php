    ...
    <section class="section">
        <div class="row">
            <div class="card">
                ...
                ?>
                <?php echo form_open_multipart('Keluarga/Update/' . $keluarga['id_keluarga']); ?>
                <?= csrf_field() ?>
                <div class="card-body">
                    <h5 class="card-title">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="kepala_keluarga" class="form-control" id="nik" value="<?= $keluarga['kepala_keluarga'] ?>">
                            <p class="text-danger"><?= $validasi->getError('kepala_keluarga') ?></p>
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Alamat</label>
                            <input type="text" class="form-control" name="alamat" id="alamat" value="<?= $keluarga['alamat'] ?>">
                            <p class="text-danger"><?= $validasi->getError('alamat') ?></p>
                        </div>
                        <div class="col-sm-2">
                            <label>RT</label>
                            <input type="number" name="rt" class="form-control" id="rt" value="<?= $keluarga['rt'] ?>">
                            <p class="text-danger"><?= $validasi->getError('rt') ?></p>
                        </div>
                        <div class="col-sm-2">
                            <label>RW</label>
                            <input type="number" name="rw" class="form-control" id="rw" value="<?= $keluarga['rw'] ?>">
