...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('HomePenduduk') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('HomePenduduk/Keluarga') ?>">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span><?= $web['nama_desa'] ?></span></strong>. All Rights Reserved
    </div>
    <div class="credits">
