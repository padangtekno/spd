...
<?php foreach ($kematian as $w => $value) { ?>

    <!-- start Vertically centered Modal-->
    <div class="modal fade" id="edit<?= $value['id_kematian'] ?>" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <?php echo form_open('Kematian/Update/' . $value['id_kematian']) ?>
                <div class="modal-body">


                    <div class="col-12">
                        <label for="">NIK</label>
                        <input value="<?= $value['nik'] ?>" class="form-control" name="nik" readonly>
                    </div>

                    <div class="col-12">
                        <label for="">Nama</label>
                        <input value="<?= $value['nama'] ?>" class="form-control" name="nik" readonly>
                    </div>

                    <div class="col-12">
                        <label for="">Tempat Meninggal</label>
                        <input value="<?= $value['tempat_kematian'] ?>" class="form-control" name="tempat_kematian" required>
                    </div>

                    <div class="col-12">
                        <label for="">Tanggal Meninggal</label>
                        <input type="date" class="form-control" value="<?= $value['tgl_kematian'] ?>" name="tgl_kematian" required>
                    </div>

                    <div class="col-12">
                        <label for="">Penyebab Meninggal</label>
                        <input type="text" class="form-control" value="<?= $value['penyebab'] ?>" name="penyebab" required>
                    </div>
    ...
    <!-- start Vertically centered Modal-->
    <div class="modal fade" id="delete<?= $value['id_kematian'] ?>" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit <?= $title ?></h5>
                ...
                <?php echo form_open('Kematian/Delete/' . $value['id_kematian'] . '/' . $value['id_penduduk']) ?>
                <div class="modal-body">


                    Yakin Hapus Data <?= $value['nik'] ?> - <?= $value['nama'] ?> ..?
